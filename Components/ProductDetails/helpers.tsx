...
export const AlertSizeNotExist = (
  <p className={styles.sizeNotExistText}>
    نعتذر يبدو أن القياس المطلوب غير متوفر حالياً لمعرفة إن كان سيتوفر بعد مدة
    معينة يرجى مراسلتنا عبر{" "}
...
export const AlertErrorSize = async () => {
  await Swal.fire({
    ...
    text: "لا تستطيع إضافة المنتج إلى حقيبة التسوق الخاصة بك, يجب عليك إدخال القياس أولاً",
    icon: "error",
