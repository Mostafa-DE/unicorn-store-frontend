import styles from "@/components/InvoiceOrder/InvoiceOrder.module.css";
...
export default function InvoiceOrderPage({ token }) {
  ...
  const alertMessageNotLoggedIn = () => {
    Swal.fire({
      ...
      text: " أنت لا تمتلك حساب أو غير مسجل دخولك لذلك لا يمكن عرض سجل الطلبات, إذا كنت تريد تتبع طلبك يرجى تحميل رقم الطلب من خلال الضغط على زر تحميل رقم الطلب وإرسالة لنا عبر أحد وسائل التواصل المعتمدة لدينا",
      icon: "error",
