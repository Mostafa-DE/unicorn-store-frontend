  ...
  return (
    <>
      ...
      <div className="text-start container containerAllText">
        <h5 data-aos="fade-in" data-aos-once='true'>Shipping policy</h5>
        ...
        <h5 data-aos="fade-in" data-aos-once='true'>Domestic Shipping Rates and Estimates</h5>
        <p data-aos="fade-in" data-aos-once='true' className="text-md-start">
        ...
        <h5 data-aos="fade-in" data-aos-once='true'>Local delivery</h5>
        <p data-aos="fade-in" data-aos-once='true' className="text-md-start">
        ...
        <h5 data-aos="fade-in" data-aos-once='true'>International Shipping</h5>
        <p data-aos="fade-in" data-aos-once='true' className="text-md-start">
