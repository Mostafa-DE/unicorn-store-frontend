  ...
  return (
    <>
      <div data-aos="fade-out" className="containerTitle">
        <h1 className="h1Title"> Terms of service </h1>
      ...
      <div className="text-start container containerAllText">
        ...
        <p data-aos="fade-in" className="text-md-start">
          This website is operated by unicorns store.Throughout the site, the
          terms “we”, “us” and “our” refer to unicorns For European Products.
          unicorns store offers this website, including all information, tools
        ...
        <p data-aos="fade-in" className="text-md-start">
          In no case shall unicorns for european products, our directors,
        ...
        <p data-aos="fade-in" className="text-md-start">
          You agree to indemnify, defend and hold harmless (unicorns for
        ...
        <p data-aos="fade-in" className="text-md-start">
          ...
          <Link href="/terms-policy/privacy-policy">
            <a data-aos="fade-in" className="link">
              Privacy Policy
            </a>
          </Link>{" "}
          &{" "}
