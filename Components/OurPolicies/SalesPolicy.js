  ...
  return (
    <>
      ...
      <div className="text-start container containerAllText">
        <h5 data-aos="fade-in">No Refunds/Exchange Only</h5>
        ...
        <h5 data-aos="fade-in">Exchange requirements</h5>
        <p data-aos="fade-in" className="text-md-start">
          The following criteria must be met to qualify for a refund:
        </p>
        <ul>
          <li data-aos="fade-in">Product is defective.</li>
          <li data-aos="fade-in">
            Product must be unopened and kept in original packaging.
          </li>
          <li data-aos="fade-in">Product must be unused.</li>
        </ul>
        <p data-aos="fade-in" className="text-md-start">
        ...
        <h5 data-aos="fade-in">No Returns or Exchanges</h5>
        <ul>
          <li data-aos="fade-in">personal items</li>
          <li data-aos="fade-in">Single-use products</li>
        </ul>
        <h5 data-aos="fade-in">Return process</h5>
        <p data-aos="fade-in" className="text-md-start">
        ...
        <p data-aos="fade-in" className="text-md-start">
          ...
          or call us at{" "}
          <a data-aos="fade-in" className="link" href="tel:0787731525">
            0787834878
          </a>
        </p>
      </div>
