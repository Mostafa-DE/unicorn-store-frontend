                ...
                {user ? (
                    <>
                        ...
                        <MenuItem onClick={() => router.push("/payment/shipping-info")}>
                            <IoBagCheckOutline style={{margin: "0 1rem 0 0", fontSize: "1.2rem"}}/> Checkout
                        </MenuItem>
                        <Divider/>
                        <MenuItem onClick={logout}>
                            <FiLogOut style={{margin: "0 1rem 0 0", fontSize: "1.2rem"}}/> Logout
                        </MenuItem>
                    </>
                ) : (
                    <>
                        ...
                        <MenuItem onClick={() => router.push("/account/login")}>
                            <FiLogIn style={{margin: "0 1rem 0 0", fontSize: "1.2rem"}}/> Login
                        </MenuItem>
                        <MenuItem onClick={() => router.push("/account/register")}>
                            <FaUserPlus style={{margin: "0 1rem 0 0", fontSize: "1.2rem"}}/> Register
                        </MenuItem>
                    </>
                )}
            </Menu>
