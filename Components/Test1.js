              ...
              <TableBody key={shippingItem.orderNumber}>
                {shippingItem.items.map((product) => (
                  ...
                  >
                    ...
                    <TableCell align="center">{product.price} JD</TableCell>
                    <TableCell align="center">{product.qty}</TableCell>
                    <TableCell align="center">
                      {shippingItem.totalBag} JD
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
          ...
          <Table aria-label="simple table">
            ...
            <TableBody>
              {shippingItems.map((shippingItem) => (
                ...
                >
                  <TableCell align="center" component="th" scope="product">
                    {`${shippingItem.firstName} ${shippingItem.lastName}`}
                  </TableCell>
                  <TableCell align="center">{shippingItem.address}</TableCell>
                  <TableCell align="center">{shippingItem.phone}</TableCell>
                  <TableCell align="center">{shippingItem.city}</TableCell>
                  <TableCell align="center">
                    {shippingItem.totalBag} JD
                  </TableCell>
                </TableRow>
