...
export const alertBenefitsToLogin = async () => {
    await Swal.fire({
        ...
        footer: `<a target="_blank" href="https://wa.me/message/HRQFZDWSM3EUH1">أنا بحاجة إلى المساعدة</a> لم تتضح الأمور بشكل جيد`
    });
};

export const alertRememberMe = async () => {
    await Swal.fire({
        icon: "warning",
        title: "👋 مرحباً",
        confirmButtonColor: "#fb9aa7",
