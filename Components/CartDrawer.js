...
export default function MenuDrawer({ closeDrawerCart, drawerCart }) {
  ...
  return (
    <div>
      <Drawer anchor="right" open={drawerCart} style={{ opacity: 0.97 }}>
        {/*-----------------Close button icon------------*/}
        <div onClick={closeDrawerCart}>
          <IconButton onClick={closeDrawerCart}>
            <FaTimes />
          </IconButton>
        </div>
        {/*--------------------------X-------------------*/}
